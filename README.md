...
1.Clone the repository:git clone https://github.com/Kavi-Cs/Enhancing-Accuracy-in-Reservoir-Drinking-Water-Quality-Assessment-Using-Machine-Learning.git
2.Install dependencies:pip install -r requirements.txt
3.Run the evaluation script:python evaluate_new_data.py --input data/unseen_water_data.csv
